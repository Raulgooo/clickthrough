...
- New likely modules: TypeScript harness runtime/service, browser/page bridge or extension-like content layer, generic DOM scanner, browser action executor, Exa-backed web tools, tool registry, scenario flows, validation layer, shared contracts, and test fixtures.
