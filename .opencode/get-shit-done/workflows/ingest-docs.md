...
```bash
INIT=$(node "C:/Users/raulg/Desktop/clickthru/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/raulg/Desktop/clickthru/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
