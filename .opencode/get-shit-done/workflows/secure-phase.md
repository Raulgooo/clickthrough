...
```
Agent(
  prompt="Read C:/Users/raulg/Desktop/clickthru/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/raulg/Desktop/clickthru/.opencode/get-shit-done/templates/SECURITY.md`
